...
@section('content')
    <div class="container">
        ...
        <form id="formRelatFinal" method="post" action="{{  route('relatorioFinalPibex.salvar') }}"
            ...
            <button type="button" id="btnAddIntegranteInterno" class="btn btn-primary mt-3">Adicionar outro
                integrante interno
            </button>
            ...
            <button type="button" id="btnAddIntegranteExterno" class="btn btn-primary mt-3">Adicionar outro
                integrante externo
            </button>
            ...
            <button type="button" id="btnAddParticipante" class="btn btn-primary mt-3">Adicionar outro
                participante
            </button>
