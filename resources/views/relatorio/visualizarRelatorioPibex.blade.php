...
@section('content')
    <div class="container">
        ...
        <input type="hidden" name="trabalho_id" value="{{ $relatorio->trabalho_id }}">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <input id="inicio_projeto" type="date" class="form-control" name="inicio_projeto"
                       value="{{ $relatorio->inicio_projeto }}" disabled>
            </div>
            ...
            <div class="col-6">
                ...
                <input id="conclusao_projeto" type="date" class="form-control" name="conclusao_projeto"
                       value="{{ $relatorio->conclusao_projeto }}" disabled>
            </div>
            ...
            <div class="col-12">
                ...
                <input id="titulo_projeto" type="text" class="form-control" name="titulo_projeto"
                       value="{{ $relatorio->titulo_projeto }}" disabled>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <input id="nome_coordenador" type="text" class="form-control" name="nome_coordenador"
                       value="{{ $coordenador->nome }}" disabled>
            </div>
            <div class="col-6">
                ...
                <input id="email_institucional_coordenador" type="email" class="form-control"
                       ...
                       value="{{ $coordenador->email_institucional }}" disabled>
            </div>
            <div class="col-6">
                ...
                <div class="row integranteExterno">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" name="instituicao_vinculo[]"
                               value="{{ $externo->intituicao_vinculo }}" disabled>
                    </div>
                    <div class="col-6">
        ...
        <div class="row">
            ...
            @if($relatorio->certificacao_adicional == true)
                <div class="col-12">
                    <div class="form-check form-check-inline">
        ...
        <form id="formRelatFinal" method="post" action="{{ route('relatorioFinalPibex.parecer') }}"
            ...
            <div class="modal-footer">
                <button name="parecer" type="submit" class="btn btn-secondary" value="devolver">Devolver para correções</button>
