...
@section('content')
    <div class="container" style="margin-top: 2%">
        ...
        <form id="criarRelatorioParte1" method="post" action="{{  route('relatorioFinalPibex.storeParte1') }}"
              enctype="multipart/form-data">
            @csrf

            <input type="hidden" name="etapa" value="etapa1">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <label for="cargo_coordenador" class="col-form-label"> <strong>{{ __('Cargo:') }}</strong> <span
                                    style="color: red; font-weight:bold;">*</span> </label>
                        <select id="cargo_coordenador" class="form-control" name="cargo_coordenador" required autocomplete="cargo_coordenador" autofocus>
                            <option value="Docente" {{ old('cargo_coordenador') == 'Docente' ? 'selected' : '' }}>Docente</option>
                            <option value="Técnico/a administrativo/a" {{ old('cargo_coordenador') == 'Técnico/a administrativo/a' ? 'selected' : '' }}>Técnico/a administrativo/a</option>
                        </select>
                    </div>
                    <div class="col-6">
