...
@section('content')
    <div class="container" style="margin-top: 2%">
        ...
        <form id="formRelatFinal" method="post" action="{{  route('relatorioFinalPibex.storeParte3') }}"
              enctype="multipart/form-data">
            @csrf
            
            <input type="hidden" name="etapa" value="etapa3">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <textarea id="resumo" class="form-control" name="resumo" rows="4" maxlength="3000" required
                                  autocomplete="resumo">{{ old('resumo') }}</textarea>
                    </div>
                </div>
                            ...
                            @for ($i = 0; $i <= 100; $i += 10)
                                <div class="w-10">
                                    <input class="form-check-input" type="radio" name="objetivos_alcancados"
                                           ...
                                           {{ old('objetivos_alcancados') == $i ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input id="pessoas_beneficiadas" type="number" class="form-control"
                               name="pessoas_beneficiadas" required autocomplete="pessoas_beneficiadas" value=" {{ old('pessoas_beneficiadas') }}">
                    </div>
                </div>
                            ...
                            @for ($i = 0; $i <= 100; $i += 10)
                                <div class="w-10">
                                    <input class="form-check-input" type="radio" name="alcance_publico_estimado"
                                           ...
                                           {{ old('alcance_publico_estimado') == $i ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <textarea id="beneficios_publico_atendido" class="form-control"
                                  ...
                                  autocomplete="beneficios_publico_atendido">{{ old('beneficios_publico_atendido') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <textarea id="impactos_tecnologicos_cientificos" class="form-control"
                                  ...
                                  autocomplete="impactos_tecnologicos_cientificos">{{ old('impactos_tecnologicos_cientificos') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <label for="desafios_encontrados"
                               class="col-form-label">
                            <strong>{{ __('7) Descreva a/s dificuldade/s e/ou desafio/s encontrado/s na execução do projeto? (caso não haja, insira um "Não houve").') }}</strong>
                            <span style="color: red; font-weight:bold;">*</span> </label>
                        <textarea id="desafios_encontrados" class="form-control" name="desafios_encontrados"
                                  rows="4" required autocomplete="desafios_encontrados">{{ old('desafios_encontrados') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <textarea id="avaliacao_projeto_executado" class="form-control"
                                  ...
                                  autocomplete="avaliacao_projeto_executado">{{ old('avaliacao_projeto_executado') }}</textarea>
                    </div>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="tecnico_cientifico" id="tecnico_cientifico"
                                           class="form-control" value="{{ old('tecnico_cientifico') }}" required></td>
                                <td><input type="number" name="qtd_tecnico_cientifico" id="qtd_tecnico_cientifico"
                                           class="form-control" value="{{ old('qtd_tecnico_cientifico') }}" required></td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td><input type="text" name="divulgacao" id="divulgacao" class="form-control" value="{{ old('divulgacao') }}"required></td>
                                <td><input type="number" name="qtd_divulgacao" id="qtd_divulgacao"
                                           class="form-control"  value="{{ old('qtd_divulgacao') }}"required></td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td><input type="text" name="didatico_instrucional" id="didatico_instrucional"
                                           class="form-control" value="{{ old('didatico_instrucional') }}" required></td>
                                <td><input type="number" name="qtd_didatico_instrucional"
                                           id="qtd_didatico_instrucional" class="form-control" value="{{ old('qtd_didatico_instrucional') }}" required></td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td><input type="text" name="multimidia" id="multimidia" class="form-control" value="{{ old('multimidia') }}" required></td>
                                <td><input type="number" name="qtd_multimidia" id="qtd_multimidia"
                                           class="form-control" value="{{ old('qtd_multimidia') }}" required></td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td><input type="text" name="artistico_cultural" id="artistico_cultural"
                                           class="form-control" value="{{ old('artistico_cultural') }}" required></td>
                                <td><input type="number" name="qtd_artistico_cultural" id="qtd_artistico_cultural"
                                           class="form-control" value="{{ old('qtd_artistico_cultural') }}" required></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
