    ...
    <div class="card" style="border-radius: 5px">
        <div class="card-body" style="padding-top: 0.2rem;">
            <div class="container">
                ...
                <div class="form-row mt-3">
                    <div class="col-md-12">
                        <p style="color: #4D4D4D; padding: 0px"><b>Nome:</b>
                            {{ App\Proponente::find($projeto->proponente_id)->user->name }}</p>
                    </div>
                    <div class="col-md-12">
                        <b style="color: #4D4D4D;">Lattes:</b>
                        @if (App\Proponente::where('id', $projeto->proponente_id)->first()->linkLattes != null)
                            <a style="color: #4D4D4D;"
                                href="{{ App\Proponente::where('id', $projeto->proponente_id)->first()->linkLattes }}"
                                target="_blank">{{ App\Proponente::where('id', $projeto->proponente_id)->first()->linkLattes }}</a>
                        @endif
                    </div>
                    ...
                    @if (Auth::user()->avaliadors != null &&
                        ...
                        <div class="col-md-12">
                            ...
                            <a style="color: #4D4D4D;" href="{{ $projeto->linkGrupoPesquisa }}"
                                target="_blank">{{ $projeto->linkGrupoPesquisa }}</a>
                        </div>
                    ...
                    @if ($edital->natureza_id == 3)
                        <div class="col-md-12">
                            ...
                            <a
                                style="color: #4D4D4D;">{{ App\AreaTematica::where('id', $projeto->area_tematica_id)->first()->nome }}</a>
                        </div>
