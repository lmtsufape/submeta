                      ...
                      <div class="container">
                          <div class="form-row mt-3">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control @error('cidade3') is-invalid @enderror" id="cidade3" name="cidade[]" placeholder="Digite a cidade do participante" required value="@if($resultado_participante_tres){{$participantes[2]->user->endereco->cep}}@endif">
                              @error('cidade3')
                              <span class="invalid-feedback" role="alert" style="overflow: visible; display:block">
                                <strong>{{ $message }}</strong>
                              </span>
