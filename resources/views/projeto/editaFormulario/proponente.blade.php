    ...
    <div class="card-body" style="padding-top: 0.2rem;">
      <div class="container">
        ...
        <div class="form-row mt-3">
          ...
          @if($edital->tipo != "PIBEX" && $edital->tipo !='CONTINUO' && $edital->tipo != "PIACEX" && $edital->tipo != "PIBAC" && $edital->tipo !='CONTINUO-AC' && $edital->tipo != "PROGRAMAS-EXTENSAO") 
            <div class="col-md-2">
              <br>
          ...
          @if($edital->tipo !='CONTINUO' && $edital->tipo != "PIBEX" && $edital->tipo != "PIACEX" && $edital->tipo != "PIBAC" && $edital->tipo !='CONTINUO-AC' && $edital->tipo != "PROGRAMAS-EXTENSAO") 
          <div class="col-md-2">
            <br>
