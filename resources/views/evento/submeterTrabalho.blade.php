...
@section('content')
    ...
    <div>
        ...
        @endif
        <!-- Modal de Aviso Edit -->
        <div class="modal fade" id="exampleModalAnexarDocumento" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12" style="font-family: 'Roboto', sans-serif;"><label
                                    id="idTituloDaMensagemModalDocumento"></label></div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light"
                            data-dismiss="modal"style="width:200px;">Fechar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalCpfInvalido" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
        ...
        @if ($edital->numParticipantes != 0)
            ...
            function marcar(id, data = null) {
                ...
                if (nome.value != "") {
                    ...
                    nomePlano.innerHTML = exibirInformacoesGeraisDoIntegrante(nome.value, email.value, celular.value, curso,
                        nome_funcao);
                    if (nome_funcao == "Bolsista") {
                        nomePlano.innerHTML +=
                            `<br><strong>Plano: </strong>${planoTrabalho.value !== null ? planoTrabalho.value : ''}`;
                    }
                } else if (data != null) {
    ...
    <script type="text/javascript">
        ...
        function verificarArquivoAnexado_pdf(item, legenda) {
            ...
            if (item.files[0].type.split('/')[1] != "pdf") {
                ...
                document.getElementById("idTituloDaMensagemModalDocumento").innerHTML =
                ...
                $("#exampleModalAnexarDocumento").modal({
                    show: true
                });
        ...
        function verificarArquivoAnexado_xls_xlsx_ods(item, legenda) {
            if (item.files[0].name.split('.')[1] == "xls" || item.files[0].name.split('.')[1] == "ods" || item.files[0].name
                .split('.')[1] == "xlsx") {
